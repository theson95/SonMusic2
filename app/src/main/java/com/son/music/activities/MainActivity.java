...
package com.son.music.activities;
...
import com.son.music.MusicPlayer;
import com.son.music.R;
import com.son.music.fragments.AlbumDetailFragment;
import com.son.music.fragments.ArtistDetailFragment;
import com.son.music.fragments.FoldersFragment;
import com.son.music.fragments.MainFragment;
import com.son.music.fragments.PlaylistFragment;
import com.son.music.fragments.QueueFragment;
import com.son.music.permissions.Nammu;
import com.son.music.permissions.PermissionCallback;
import com.son.music.slidinguppanel.SlidingUpPanelLayout;
import com.son.music.utils.Constants;
import com.son.music.utils.NavigationUtils;
import com.son.music.utils.TimberUtils;
...
public class MainActivity extends BaseActivity implements ATEActivityThemeCustomizer {
    ...
    private void checkPermissionAndThenLoad() {
        ...
        if (Nammu.checkPermission(Manifest.permission.READ_EXTERNAL_STORAGE)) {
            ...
            if (Nammu.shouldShowRequestPermissionRationale(this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
                Snackbar.make(panelLayout, "SonMusic will need to read external storage to display songs on your device.",
    ...
    private void setupNavigationIcons(NavigationView navigationView) {
        ...
        if (!isDarkTheme) {
            navigationView.getMenu().findItem(R.id.nav_library).setIcon(R.drawable.home_icon_sm);
            navigationView.getMenu().findItem(R.id.nav_playlists).setIcon(R.drawable.playlist_icon_sm);
            //navigationView.getMenu().findItem(R.id.nav_queue).setIcon(R.drawable.music_note);
            //navigationView.getMenu().findItem(R.id.nav_folders).setIcon(R.drawable.ic_folder_open_black_24dp);
            navigationView.getMenu().findItem(R.id.nav_nowplaying).setIcon(R.drawable.nowplaying_icon_sm);
     //       navigationView.getMenu().findItem(R.id.nav_settings).setIcon(R.drawable.settings);
   //         navigationView.getMenu().findItem(R.id.nav_about).setIcon(R.drawable.information);
   //         navigationView.getMenu().findItem(R.id.nav_donate).setIcon(R.drawable.payment_black);
        } else {
            navigationView.getMenu().findItem(R.id.nav_library).setIcon(R.drawable.playlist_icon_sm);
